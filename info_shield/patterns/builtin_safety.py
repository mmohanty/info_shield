...
def get_patterns() -> List[PatternDef]:
    return [
        PatternDef(
            ...
            category="Safety",
            severity="high",
            regexes=[r"(?i)\bignore\s+(?:all\s+)?previous\s+instructions\b"],
        ),
        PatternDef(
            ...
            category="Safety",
            severity="medium",
            regexes=[r"(?i)\b(system\s*prompt|developer\s*instructions?)\b"],
        ),
        PatternDef(
            ...
            category="Safety",
            severity="medium",
            regexes=[r"(?i)\b(?:pretend|role[-\s]?play)\s+to\s+be\b"],
        ),
        PatternDef(
            ...
            category="Safety",
            severity="high",
            regexes=[r"(?i)\b(disregard|bypass|circumvent)\s+(?:the\s+)?(?:rules?|safety|guardrails?|policy|policies)\b"],
        ),
    ]
